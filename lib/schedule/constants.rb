module Schedule
  class Constants
    ...
    CORE_CODES = %w(
      PB PF PM PS PN    MD MF MG MM MS MN       ML XN
      XS YA YB Y1 YC YR YX YS YN    YG YL DO CC VP CS
      CUST
    )
    # PB PF PM PS PN PU PA MD MF MM MS MN MU MA ML XN
    # XS YA YB Y1 YC YR YX YS YN YF YG YL DO CC VP
